...
public class SettingsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String[] citiesNamesArr = {"Kraków", "Londyn", "Nowy Jork"};
    private static final int[] citiesIdArr = {3094802, 2643743, 5128581};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SettingsActivity.this, android.R.layout.simple_spinner_item, citiesNamesArr);
...
//        });
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        saveLocationToSharedPreferences(String.valueOf(citiesIdArr[position]), citiesNamesArr[position]);
    }
